...
// const categoryMap = {
//   1: "Beverages",        // ചായ, കാപ്പി തുടങ്ങിയ പാനീയങ്ങൾ
//   2: "Chocolate",           // ജ്യൂസുകൾ, സോഫ്റ്റ് ഡ്രിങ്ക്‌സ് തുടങ്ങിയവ
//   3: "Drinks",        // ചോക്ലേറ്റ് ഉൽപ്പന്നങ്ങൾ
//   4: "Others"            // മറ്റുള്ളവ
// };
...
import Transaction from './Transaction';
import UserAnnounce from './UserAnnounce';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {activeTab === 'UserAnnounce' && <UserAnnounce />}
      </div>
